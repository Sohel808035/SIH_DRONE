...
# Define paths
dataset_dir = Path('datasets/final')
images_dir = dataset_dir / 'train' / 'images'
labels_dir = dataset_dir / 'train' / 'labels'
output_path = dataset_dir / 'final_dataset_samples.jpg'
...
def draw_annotations(image, label_file):
    ...
    for line in lines:
        ...
        try:
            ...
            colors = {
                0: (0, 255, 255),    # flood - cyan
                1: (255, 0, 0),      # smoke - blue
                2: (0, 0, 255),      # fire - red
                3: (0, 255, 0),      # debris - green
                4: (255, 0, 255),    # landslide - magenta
