...
# Define paths
dataset_dir = Path('datasets/landslide/extracted')
images_dir = dataset_dir / 'train' / 'images'
labels_dir = dataset_dir / 'train' / 'labels'
output_dir = dataset_dir / 'verification'
output_path = output_dir / 'landslide_samples.jpg'
...
def draw_annotations(image, label_file):
    """Draw bounding boxes and 'landslide' labels on image."""
    ...
    for line in lines:
        ...
        try:
            ...
            # Draw label
            cv2.putText(image, 'landslide', (x1, y1 - 5), 
